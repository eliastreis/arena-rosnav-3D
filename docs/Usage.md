...
To select one of our pre-build worlds, specify your scenario by selecting **aws_house**,  turtlebot3_house, small_warehouse,  experiment_rooms (2, 3, 4), factory or hospital in your startup file: *(bold is your default world)*
```bash
